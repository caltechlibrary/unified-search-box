...
function searchboxHTML($basepath = "") {
    $src = <<<HTML
<!-- START: Google Searchbox, 2015-12-10 -->
<script>
  (function() {
     var cx = '005709273917748521174:po9fevg5ksw';
...
<!-- END: Google Searchbox, 2015-12-10 -->
  ...
  <div id="usb-searchbox" class="usb-searchbox usb-hide">
    <div class="usb-search-resources">
        ...
        <div id="usb-search-resources" class="usb-menu">
            ...
            <span id="usb-resource-menu-selected" class="usb-menu-selected">LibSearch</span>
...
function searchboxJavaScript($basepath = "") {
	return PHP_EOL .
        '<script src="' . joinPath($basepath, 'js/ebscohostsearch.js') . '" rel="javascript" type="text/javascript"></script>' . PHP_EOL .
        '<script src="' . joinPath($basepath, 'js/tindhostsearch.js') . '" rel="javascript" type="text/javascript"></script>' . PHP_EOL .
	    '<script src="' . joinPath($basepath, 'js/usb.js') . '" rel="javascript" type="text/javascript"></script>' . PHP_EOL;
}
?>
