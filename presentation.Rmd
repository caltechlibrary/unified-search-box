...
+ we were planning a complete website re-design
    + this project is interum
    + we're managing legacy
+ our infrastructure is rather organic
    + this suggested an evolutionary approach
    + but I couldn't assume Wordpress/Drupal at this stage
+ I didn't know what browsers variations common for our visitors
...
+ given legacy nature of current website
  ...
  + not taking a true progressive enhancement approach
...
Our legacy implementation dated from the IE 6 era when graded browser support was the best practice

## graded browser support

+ Approach was made popular at Yahoo many years ago
+ It lets you breakdown the browser support challenges into something manageable list
...
+ Picked the baseline (minimal feature set)
+ Decided what is required for the enhanced features
+ Verified what browsers supported those features based on [caniuse](http://caniuse.com)
...
Grade A was testable with the help of other staff (who had things like iPhones)
...
# As you would expect this leads to

## the [Nac Mac Feegle](https://en.wikipedia.org/wiki/Nac_Mac_Feegle)  
...
Because this is very similar to progressive enhancement but without feature testing.
