...
+ given legacy nature of current website
    + knew I was not implementing a responsive approach
...
Our legacy website implementation dated from the IE 6 era. I started to realize it was unreasonable to implement the full progressive enhancement treatment. This website was designed when graded browser support was the best practice. 

+ [Old Catalog Searchbox](http://library.caltech.edu/index-old.php)

---

# As you would expect this leads the developer to

## call on the [Nac Mac Feegle](https://en.wikipedia.org/wiki/Nac_Mac_Feegle)  
...
But I wound up with something very similar to progressive enhancement but without feature testing.
